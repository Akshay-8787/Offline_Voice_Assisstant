...
def start_phone_controller():
    ...
    try:
        ...
        # Give Flask a moment to start, then verify the child did not crash.
        time.sleep(1)

        if process.poll() is not None:
            print("Phone controller failed to start. Check the phone_server.py output above.")
            return None

        print("Phone controller started.")
        print("Open https://<PC-IP>:5000 on your phone.")
...
def main():
    ...
    try:
        ...
        # Local AI brain (Ollama + Qwen 2.5 3B)
        ai_brain = AIBrain()
    ...
    print("AI Conversation: ENABLED (Ollama + Qwen 2.5 3B)")
    print("Listening...")
    print()
        ...
        for text in recognizer.listen_forever():
            ...
            if command.action == "unknown":
                ...
                try:
                    ...
                    message = (
                        "I couldn't connect to my local AI."
                    )
